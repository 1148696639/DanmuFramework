...
namespace QFramework
{
    ...
    public interface ISystem : IBelongToArchitecture, ICanSetArchitecture, ICanGetModel, ICanGetUtility,
        ICanRegisterEvent, ICanSendEvent, ICanGetSystem,ICanSendQuery
    {
        void Init();
    }
    ...
    public class UnRegisterDisableTrigger : MonoBehaviour
    {
        private readonly HashSet<IUnRegister> mUnRegisters = new HashSet<IUnRegister>();
    ...
    public static class UnRegisterExtension
    {
        ...
        public static IUnRegister UnRegisterWhenGameObjectDisable(this IUnRegister unRegister, GameObject gameObject)
        {
            var trigger = gameObject.GetComponent<UnRegisterDisableTrigger>();

            if (!trigger)
            {
                trigger = gameObject.AddComponent<UnRegisterDisableTrigger>();
            }
